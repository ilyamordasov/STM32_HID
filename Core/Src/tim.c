...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, CLK_Pin|DT_Pin);
...
void HAL_TIM_Encoder_Get(RE_t *data) {
	...
	/* Check */
	if (data->RE_Count < 0) {
		printf("RE_Rotate_Decrement\r\n");
	}
	else if (data->RE_Count > 0) {
		printf("RE_Rotate_Increment\r\n");
	}
}
...
uint8_t HAL_TIM_Encoder_Get_Direction(RE_t *data) {
	...
	/* Check difference */
	//if (data->LastA - now_b < 0) {
	if (now_b > data->LastA) {
		//printf("RE_Rotate_Increment\r\n");
		dir = RE_Rotate_Increment;
	} else {
		//printf("RE_Rotate_Decrement\r\n");
		dir = RE_Rotate_Decrement;
	}
	data->LastA = now_b;
	return dir;
}
